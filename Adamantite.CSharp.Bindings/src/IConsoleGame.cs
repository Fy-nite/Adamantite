...
public class IConsoleGame
{
    ...
    private static extern IntPtr IConsoleGame_Create();
    /// <summary>Creates a new native instance via the default constructor.</summary>
    public IConsoleGame() { _native = IConsoleGame_Create(); }
    /// <summary>Wraps an existing native pointer. Does not take ownership.</summary>
    public IConsoleGame(IntPtr nativeHandle) { _native = nativeHandle; }
    [DllImport("Adamantite.video", CallingConvention = CallingConvention.Cdecl)]
    ...
    public void Init(Canvas surface)
    {
        ...
        IConsoleGame_Init(_native, _raw_surface);
    }
    [DllImport("Adamantite.video", CallingConvention = CallingConvention.Cdecl)]
    ...
    {
        var _raw_surface = surface._Handle;
        IConsoleGame_Draw(_native, _raw_surface);
    }
}
