...
public class Button
{
    ...
    public void Draw(Canvas canvas, IntPtr arg1)
    {
        ...
        Button_Draw(_native, _raw_canvas, arg1);
    }
    [DllImport("Adamantite.video", CallingConvention = CallingConvention.Cdecl)]
