...
public static class NativeBindings_AdsrGraph
{
}
...
public class AdsrGraph
{
    ...
    private static extern IntPtr AdsrGraph_Create();
    /// <summary>Creates a new native instance via the default constructor.</summary>
    public AdsrGraph() { _native = AdsrGraph_Create(); }
    /// <summary>Wraps an existing native pointer. Does not take ownership.</summary>
    public AdsrGraph(IntPtr nativeHandle) { _native = nativeHandle; }
    [DllImport("Adamantite.video", CallingConvention = CallingConvention.Cdecl)]
    private static extern void AdsrGraph_Draw(IntPtr instance, IntPtr canvas, IntPtr arg1);
    public void Draw(Canvas canvas, IntPtr arg1)
    {
        var _raw_canvas = canvas._Handle;
        AdsrGraph_Draw(_native, _raw_canvas, arg1);
    }
}
